(self.webpackChunkmy_strapi_project=self.webpackChunkmy_strapi_project||[]).push([[2544],{98374:(U,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(67294),h=o(23246),P=o(86896),v=o(88767);const O=(T={},R={})=>{const{id:E="",...S}=T,{get:V}=(0,h.kY)(),{locale:a}=(0,P.Z)(),Z=(0,h.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",E,S],async()=>{const{data:Q}=await V(`/admin/roles/${E??""}`,{params:S});return Q},R);return{roles:e.useMemo(()=>{let Q=[];return m&&(Array.isArray(m.data)?Q=m.data:Q=[m.data]),[...Q].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,Z]),error:M,isError:F,isLoading:g,refetch:b}}},24233:(U,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(23246),h=o(88767);const P=(v={id:null},O={})=>{const{id:T,...R}=v,{get:E}=(0,e.kY)(),{data:S,error:V,isError:a,isLoading:Z,refetch:m}=(0,h.useQuery)(["roles",T,"permissions",R],async()=>{const{data:{data:M}}=await E(`/admin/roles/${T}/permissions`,{params:R});return M},O);return{permissions:S,error:V,isError:a,isLoading:Z,refetch:m}}},25545:(U,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>me,default:()=>Ae});var e=o(67294),h=o(40720),P=o(90731),v=o(96987),O=o(12473),T=o(34726),R=o(16607),E=o(10574),S=o(31988),V=o(6498),a=o(38670),Z=o(457),m=o(23246),M=o(97695),F=o(66115),g=o(41054),b=o(41609),z=o.n(b),Q=o(86896),oe=o(70743),ee=o(16550),C=o(71997),de=o(36364),J=o(30909),te=o(90065),Y=o(24233),ue=o(87561);const Le=ue.Ry().shape({name:ue.Z_().required(m.I0.required),description:ue.Z_().required(m.I0.required)}),ce=C.ZP.div`
